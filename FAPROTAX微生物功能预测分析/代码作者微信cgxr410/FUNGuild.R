VX_cgxr410_FUNGuild <- function(VXcgxr410) {
  ...
  # 保存图像和最终结果
  ggsave('18s-ITS/1.plot_FUNGuild.pdf', plot = p, width = width1, height = height1)
  write.csv(t2$res_spe_func_perc, file = "18s-ITS/result_FUNGuild.csv", row.names = TRUE)
  ...
  # 打印图形
  ggsave('18s-ITS/2.boxplot_FUNGuild.pdf', plot = p1, width = width2, height = height2)
  return(result_FUNGuild=result_FAPROTAX)
}
